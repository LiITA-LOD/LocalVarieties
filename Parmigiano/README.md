...
```
**Query the [Compl-IT lexicon](https://dspace-clarin-it.ilc.cnr.it/repository/xmlui/handle/20.500.11752/ILC-1007) to find definitions that begin with the word *uccello* (EN: *bird*), the correspoding Italian entry and the translation into Parmigiano of Sicilian.**

[Results](https://liita.it/sparql?default-graph-uri=&query=PREFIX+ontolex%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0D%0APREFIX+lexinfo%3A+%3Chttp%3A%2F%2Fwww.lexinfo.net%2Fontology%2F3.0%2Flexinfo%23%3E%0D%0APREFIX+skos%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F2004%2F02%2Fskos%2Fcore%23%3E%0D%0APREFIX+vartrans%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fvartrans%23%3E%0D%0APREFIX+rdfs%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%0D%0A%0D%0ASELECT+DISTINCT+%0D%0A++%3FlemmaIT%0D%0A++%3Fdefinition%0D%0A++%3FwrDIALECT%0D%0AWHERE+%7B%0D%0A%0D%0A++%23+---+SERVICE+Compl-It+---%0D%0A++SERVICE+%3Chttps%3A%2F%2Fklab.ilc.cnr.it%2Fgraphdb-compl-it%2F%3E+%7B%0D%0A%0D%0A++++%3FentryIT+a+ontolex%3ALexicalEntry+%3B%0D%0A+++++++++++++ontolex%3AcanonicalForm+%3FformIT+%3B%0D%0A+++++++++++++ontolex%3Asense+%3Fsense+%3B%0D%0A+++++++++++++lexinfo%3ApartOfSpeech+lexinfo%3Anoun+.%0D%0A%0D%0A++++%3FformIT+ontolex%3AwrittenRep+%3FlemmaIT+.%0D%0A%0D%0A++++OPTIONAL+%7B%0D%0A++++++%3Fsense+skos%3Adefinition+%3Fdefinition+.%0D%0A++++%7D%0D%0A%0D%0A++++FILTER%28STRSTARTS%28LCASE%28STR%28%3Fdefinition%29%29%2C+%22uccello%22%29%29%0D%0A++%7D%0D%0A%0D%0A++%23+---+LiITA%3A+match+per+stringa+---%0D%0A++%3FentryIT_liita+a+ontolex%3ALexicalEntry+%3B%0D%0A+++++++++++++++++ontolex%3AcanonicalForm+%3FformIT_liita+.%0D%0A%0D%0A++%3FformIT_liita+ontolex%3AwrittenRep+%3FlemmaIT+.%0D%0A%0D%0A++%23+---+traduzioni+%28tutte+le+varianti%29+---%0D%0A++%7B%0D%0A++++%3FentryIT_liita+vartrans%3AtranslatableAs+%3FentryDIALECT+.%0D%0A++%7D%0D%0A++UNION%0D%0A++%7B%0D%0A++++%3FentryDIALECT+vartrans%3AtranslatableAs+%3FentryIT_liita+.%0D%0A++%7D%0D%0A%0D%0A++%23+---+parmigiano+---%0D%0A++%3FentryDIALECT+ontolex%3AcanonicalForm+%3FformDIALECT+.%0D%0A++%3FformDIALECT+ontolex%3AwrittenRep+%3FwrDIALECT+.%0D%0A%0D%0A%7D%0D%0AORDER+BY+%3FlemmaIT+%3FwrDIALECT&format=text%2Fhtml&should-sponge=&timeout=0&signal_void=on)
```
PREFIX ontolex: <http://www.w3.org/ns/lemon/ontolex#>
