...
**1) Find all Sicilian lemmas having written representations containing the alternation "ed"-"ied".**
...
**2) Find all Sicilian lemmas having written representations starting with "d" or "r".**
...
**3) Find Sicilian common nouns ending with the abstract suffix "ìa" and show the correspoding Italian translations.**
...
**4) Find Sicilian entries having a feminine gender which Italian translation is masculine.**
...
**5) Find Italian verbs of the first conjugation (ending with "-are") and shows the corresponding translations in Parmigiano and Sicilian.**
...
**6) Find Italian adjectives ending with "-oso" and having a translation in Sicilian and in the Parma dialect showing the definition taken from the CompL-it lexicon.**
...
**7) Find a specific token in the treebank.**
...
SELECT DISTINCT ?sentenceNum ?tokenLabel ?lemmaLabel ?docTitle
WHERE {
  VALUES ?copora {
  ...
  ?token rdf:type powla:Terminal ;
         rdfs:label "spavintatu" ;
         lila:hasLemma ?lemma .

  BIND("spavintatu" AS ?tokenLabel)

  ?lemma ontolex:writtenRep ?lemmaLabel .
  ...
  BIND(STRAFTER(STR(?token), "Sentence_") AS ?afterSentence)
  BIND(xsd:integer(STRBEFORE(?afterSentence, "/")) AS ?sentenceNum)
}
ORDER BY ?docTitle ?sentenceNum
```

**8) Find the noun lemmas occurring as nominal subjects (nsubj) of the verb _diciri_ (to say) in the Sicilian Treebank.**
...
**9) Extract all adjective lemmas attested in the Sicilian Treebank, identify their Italian equivalents and, whenever available, the corresponding Parmigiano dialect translations.**
...
**10) Find Sicilian verbs attested in the Sicilian Treebank whose Italian translation ends in _-are_, and retrieve their corresponding Parmigiano equivalents.**
...
**11) Find all verbs annotated with the imperative mood (Mood=Imp) in the STB corpus, returning the token form, its associated lemma, and, when available, the corresponding Italian translation and the translation in the Parma dialect.**
...
**12) Find nouns, verbs, and adjectives that are exclusive to one of two Sicilian versions of the Colapisci text (Ganzirri 1904 vs. Roccalumera 1904) in the STB corpus.**
...
**13) Find all occurrences of the Sicilian lemma essiri (_to be_) in the Sicilian Treebank, together with their document of origin and the associated Universal Dependencies morphological features (e.g., mood, number, person, tense, and verb form). Duplicates are removed.**

[Results](https://liita.it/sparql?default-graph-uri=&query=PREFIX+powla%3A+%3Chttp%3A%2F%2Fpurl.org%2Fpowla%2Fpowla.owl%23%3E%0D%0APREFIX+rdf%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0D%0APREFIX+rdfs%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%0D%0APREFIX+dc%3A+%3Chttp%3A%2F%2Fpurl.org%2Fdc%2Felements%2F1.1%2F%3E%0D%0APREFIX+ontolex%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0D%0APREFIX+lila%3A+%3Chttp%3A%2F%2Flila-erc.eu%2Fontologies%2Flila%2F%3E%0D%0APREFIX+oa%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Foa%23%3E%0D%0A%0D%0ASELECT+DISTINCT%0D%0A++%28CONCAT%28%3Fmood%2C+%22+%7C+%22%2C+%3Fnumber%2C+%22+%7C+%22%2C+%3Fperson%2C+%22+%7C+%22%2C+%3Ftense%2C+%22+%7C+%22%2C+%3Fverbform%29+AS+%3Ffeatures%29%0D%0A++%3FtokenLabel+%3FdocTitle%0D%0AWHERE+%7B%0D%0A++VALUES+%3Fcopora+%7B%0D%0A++++%3Chttp%3A%2F%2Fliita.it%2Fdata%2Fid%2Fcorpora%2FSTB%2Fid%2Fcorpus%3E%0D%0A++%7D%0D%0A%0D%0A++%3Flemma+a+lila%3ALemma+%3B%0D%0A+++++++++ontolex%3AwrittenRep+%22essiri%22%40scn+.%0D%0A%0D%0A++%3Ftoken+rdf%3Atype+powla%3ATerminal+%3B%0D%0A+++++++++lila%3AhasLemma+%3Flemma+%3B%0D%0A+++++++++rdfs%3Alabel+%3FtokenLabel+.%0D%0A%0D%0A++%3Ftoken+powla%3AhasLayer%2Fpowla%3AhasDocument%2F%5Epowla%3AhasSubDocument+%3Fcopora+.%0D%0A++%3Ftoken+powla%3AhasLayer%2Fpowla%3AhasDocument+%3Fdoc+.%0D%0A++%3Fdoc+dc%3Atitle+%3FdocTitle+.%0D%0A%0D%0A++OPTIONAL+%7B%0D%0A++++SELECT+%3Ftoken+%28SAMPLE%28%3Fm%29+AS+%3Fmood%29+WHERE+%7B%0D%0A++++++%3Fa+oa%3AhasTarget+%3Ftoken+%3B+oa%3AhasBody+%3Fb+.%0D%0A++++++FILTER%28STRSTARTS%28STR%28%3Fb%29%2C+%22https%3A%2F%2Funiversaldependencies.org%2Fit%2Ffeat%2FMood%23%22%29%29%0D%0A++++++BIND%28STRAFTER%28STR%28%3Fb%29%2C+%22%2Ffeat%2F%22%29+AS+%3Fm%29%0D%0A++++%7D+GROUP+BY+%3Ftoken%0D%0A++%7D%0D%0A++OPTIONAL+%7B%0D%0A++++SELECT+%3Ftoken+%28SAMPLE%28%3Fn%29+AS+%3Fnumber%29+WHERE+%7B%0D%0A++++++%3Fa+oa%3AhasTarget+%3Ftoken+%3B+oa%3AhasBody+%3Fb+.%0D%0A++++++FILTER%28STRSTARTS%28STR%28%3Fb%29%2C+%22https%3A%2F%2Funiversaldependencies.org%2Fit%2Ffeat%2FNumber%23%22%29%29%0D%0A++++++BIND%28STRAFTER%28STR%28%3Fb%29%2C+%22%2Ffeat%2F%22%29+AS+%3Fn%29%0D%0A++++%7D+GROUP+BY+%3Ftoken%0D%0A++%7D%0D%0A++OPTIONAL+%7B%0D%0A++++SELECT+%3Ftoken+%28SAMPLE%28%3Fp%29+AS+%3Fperson%29+WHERE+%7B%0D%0A++++++%3Fa+oa%3AhasTarget+%3Ftoken+%3B+oa%3AhasBody+%3Fb+.%0D%0A++++++FILTER%28STRSTARTS%28STR%28%3Fb%29%2C+%22https%3A%2F%2Funiversaldependencies.org%2Fit%2Ffeat%2FPerson%23%22%29%29%0D%0A++++++BIND%28STRAFTER%28STR%28%3Fb%29%2C+%22%2Ffeat%2F%22%29+AS+%3Fp%29%0D%0A++++%7D+GROUP+BY+%3Ftoken%0D%0A++%7D%0D%0A++OPTIONAL+%7B%0D%0A++++SELECT+%3Ftoken+%28SAMPLE%28%3Ft%29+AS+%3Ftense%29+WHERE+%7B%0D%0A++++++%3Fa+oa%3AhasTarget+%3Ftoken+%3B+oa%3AhasBody+%3Fb+.%0D%0A++++++FILTER%28STRSTARTS%28STR%28%3Fb%29%2C+%22https%3A%2F%2Funiversaldependencies.org%2Fit%2Ffeat%2FTense%23%22%29%29%0D%0A++++++BIND%28STRAFTER%28STR%28%3Fb%29%2C+%22%2Ffeat%2F%22%29+AS+%3Ft%29%0D%0A++++%7D+GROUP+BY+%3Ftoken%0D%0A++%7D%0D%0A++OPTIONAL+%7B%0D%0A++++SELECT+%3Ftoken+%28SAMPLE%28%3Fv%29+AS+%3Fverbform%29+WHERE+%7B%0D%0A++++++%3Fa+oa%3AhasTarget+%3Ftoken+%3B+oa%3AhasBody+%3Fb+.%0D%0A++++++FILTER%28STRSTARTS%28STR%28%3Fb%29%2C+%22https%3A%2F%2Funiversaldependencies.org%2Fit%2Ffeat%2FVerbForm%23%22%29%29%0D%0A++++++BIND%28STRAFTER%28STR%28%3Fb%29%2C+%22%2Ffeat%2F%22%29+AS+%3Fv%29%0D%0A++++%7D+GROUP+BY+%3Ftoken%0D%0A++%7D%0D%0A%7D%0D%0AORDER+BY+DESC%28%3Ffeatures%29+%3FdocTitle+%3FtokenLabel&format=text%2Fhtml&should-sponge=&timeout=0&signal_void=on)
```
PREFIX powla: <http://purl.org/powla/powla.owl#>
PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
...
**14) Find all _advmod_ (adverbial modifier) syntactic relations in the Sicilian treebank, returning the head lemma and its dependent adverb lemma along with their Italian translations (when available) and the source document title.**
...
**15) Find all _root_ syntactic relations in the Sicilian treebank, groups them by lemma (showing both its canonical rdfs:label and its OntoLex written forms), counts how often each lemma occurs as a sentence root, and includes its Italian translation when available, ordered from most to least frequent,**

[Results](https://liita.it/sparql?default-graph-uri=&query=PREFIX+powla%3A+%3Chttp%3A%2F%2Fpurl.org%2Fpowla%2Fpowla.owl%23%3E%0D%0APREFIX+rdf%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0D%0APREFIX+rdfs%3A+%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%0D%0APREFIX+dcterms%3A+%3Chttp%3A%2F%2Fpurl.org%2Fdc%2Fterms%2F%3E%0D%0APREFIX+lilacorpora%3A+%3Chttp%3A%2F%2Flila-erc.eu%2Fontologies%2Flila_corpora%2F%3E%0D%0APREFIX+lila%3A+%3Chttp%3A%2F%2Flila-erc.eu%2Fontologies%2Flila%2F%3E%0D%0APREFIX+ontolex%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0D%0APREFIX+vartrans%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fvartrans%23%3E%0D%0APREFIX+UDSynFunction%3A+%3Chttps%3A%2F%2Funiversaldependencies.org%2Fu%2Fdep%2F%3E%0D%0A%0D%0ASELECT%0D%0A++%3FrootLemma%0D%0A++%3FlemmaLabel%0D%0A++%3FrootLemmaLabel%0D%0A++%28GROUP_CONCAT%28DISTINCT+%3FwrIT%3B+separator%3D%22%2C+%22%29+AS+%3FwrsIT%29%0D%0A++%28COUNT%28%3Frel%29+AS+%3Ffreq%29%0D%0AWHERE+%7B%0D%0A++VALUES+%3Fcopora+%7B%0D%0A++++%3Chttp%3A%2F%2Fliita.it%2Fdata%2Fid%2Fcorpora%2FSTB%2Fid%2Fcorpus%3E%0D%0A++%7D%0D%0A++VALUES+%3FsynFunctions+%7B%0D%0A++++UDSynFunction%3Aroot%0D%0A++%7D%0D%0A%0D%0A++%3Frel+rdf%3Atype+%3FsynFunctions+%3B%0D%0A+++++++lilacorpora%3AhasDep+%3Fdep+.%0D%0A%0D%0A++%3Fdep+lila%3AhasLemma+%3FrootLemma+.%0D%0A++%3Fdep+powla%3AhasLayer%2Fpowla%3AhasDocument%2F%5Epowla%3AhasSubDocument+%3Fcopora+.%0D%0A%0D%0A++%3FrootLemma+ontolex%3AwrittenRep+%3FrootLemmaLabel+.%0D%0A%0D%0A++OPTIONAL+%7B%0D%0A++++%3FrootLemma+rdfs%3Alabel+%3FlemmaLabel+.%0D%0A++%7D%0D%0A%0D%0A++%23+---+traduzione+italiana+---%0D%0A++OPTIONAL+%7B%0D%0A++++%3Fle+ontolex%3AcanonicalForm+%3FrootLemma+.%0D%0A++++%3FleITA+vartrans%3AtranslatableAs+%3Fle+%3B%0D%0A+++++++++++ontolex%3AcanonicalForm+%3FliitaLemmaIT+.%0D%0A++++%3FliitaLemmaIT+ontolex%3AwrittenRep+%3FwrIT+.%0D%0A++++%3FliitaLemmaIT+dcterms%3AisPartOf+%3Chttp%3A%2F%2Fliita.it%2Fdata%2Fid%2Flemma%2FLemmaBank%3E+.%0D%0A++%7D%0D%0A%7D%0D%0AGROUP+BY+%3FrootLemma+%3FlemmaLabel+%3FrootLemmaLabel%0D%0AORDER+BY+DESC%28%3Ffreq%29&format=text%2Fhtml&should-sponge=&timeout=0&signal_void=on)
